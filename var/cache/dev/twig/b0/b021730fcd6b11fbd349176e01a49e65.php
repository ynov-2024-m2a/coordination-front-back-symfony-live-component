...
class __TwigTemplate_8868edef1b754fb40a66c9a31ec7b2e9 extends Template
{
    ...
    ";
        // line 2
        yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("ux:icon", ["name" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["this"]) || array_key_exists("this", $context) ? $context["this"] : (function () { throw new RuntimeError('Variable "this" does not exist.', 2, $this->source); })()), "icon", [], "any", false, false, false, 2), "class" => "Icon bi"]);
        yield "
    ";
        // line 3
    ...
    {{ component('ux:icon', { name: (this.icon), class: 'Icon bi' }) }}
    {{ message }}
</div>", "components/Alert.html.twig", "/Users/ilyesdeochandiano/Library/Mobile Documents/com~apple~CloudDocs/ProjetDev/coordination-front-back-symfony-live-component/templates/components/Alert.html.twig");
    }
}
