O:41:"Symfony\Component\AssetMapper\MappedAsset":12:{s:10:"sourcePath";s:149:"/Users/ilyesdeochandiano/Library/Mobile Documents/com~apple~CloudDocs/ProjetDev/coordination-front-back-symfony-live-component/assets/styles/app.scss";s:10:"publicPath";s:55:"/assets/styles/app-4a2f3c29eccd8d428eb95a0384913097.css";s:23:"publicPathWithoutDigest";s:22:"/assets/styles/app.css";s:15:"publicExtension";s:3:"css";s:7:"content";s:326304:"@charset "UTF-8";
/*!
...
[data-bs-theme=light] {
  ...
  --bs-success-rgb: 132, 222, 44;
  --bs-info-rgb: 13, 202, 240;
  --bs-warning-rgb: 251, 198, 64;
  --bs-danger-rgb: 251, 64, 64;
  --bs-light-rgb: 248, 249, 250;
  --bs-dark-rgb: 33, 37, 41;
  --bs-primary-text-emphasis: #0e0e0e;
  --bs-secondary-text-emphasis: #2b2f32;
  --bs-success-text-emphasis: #355912;
  --bs-info-text-emphasis: #055160;
  --bs-warning-text-emphasis: #644f1a;
  --bs-danger-text-emphasis: #641a1a;
  --bs-light-text-emphasis: #495057;
  --bs-dark-text-emphasis: #495057;
  --bs-primary-bg-subtle: lightgray;
  --bs-secondary-bg-subtle: #e2e3e5;
  --bs-success-bg-subtle: #e6f8d5;
  --bs-info-bg-subtle: #cff4fc;
  --bs-warning-bg-subtle: #fef4d9;
  --bs-danger-bg-subtle: #fed9d9;
  --bs-light-bg-subtle: #fcfcfd;
  --bs-dark-bg-subtle: #ced4da;
  --bs-primary-border-subtle: #a7a7a7;
  --bs-secondary-border-subtle: #c4c8cb;
  --bs-success-border-subtle: #cef2ab;
  --bs-info-border-subtle: #9eeaf9;
  --bs-warning-border-subtle: #fde8b3;
  --bs-danger-border-subtle: #fdb3b3;
  --bs-light-border-subtle: #e9ecef;
  --bs-dark-border-subtle: #adb5bd;
  --bs-white-rgb: 255, 255, 255;
  --bs-black-rgb: 0, 0, 0;
  --bs-font-sans-serif: system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
  --bs-font-monospace: var(--font-family-code);
  ...
  --bs-form-valid-color: #84DE2C;
  --bs-form-valid-border-color: #84DE2C;
  --bs-form-invalid-color: #FB4040;
  --bs-form-invalid-border-color: #FB4040;
}
...
[data-bs-theme=dark] {
  ...
  --bs-primary-text-emphasis: #7a7a7a;
  --bs-secondary-text-emphasis: #a7acb1;
  --bs-success-text-emphasis: #b5eb80;
  --bs-info-text-emphasis: #6edff6;
  --bs-warning-text-emphasis: #fddd8c;
  --bs-danger-text-emphasis: #fd8c8c;
  --bs-light-text-emphasis: #f8f9fa;
  --bs-dark-text-emphasis: #dee2e6;
  --bs-primary-bg-subtle: #070707;
  --bs-secondary-bg-subtle: #161719;
  --bs-success-bg-subtle: #1a2c09;
  --bs-info-bg-subtle: #032830;
  --bs-warning-bg-subtle: #32280d;
  --bs-danger-bg-subtle: #320d0d;
  --bs-light-bg-subtle: #343a40;
  --bs-dark-bg-subtle: #1a1d20;
  --bs-primary-border-subtle: #141414;
  --bs-secondary-border-subtle: #41464b;
  --bs-success-border-subtle: #4f851a;
  --bs-info-border-subtle: #087990;
  --bs-warning-border-subtle: #977726;
  --bs-danger-border-subtle: #972626;
  --bs-light-border-subtle: #495057;
  --bs-dark-border-subtle: #343a40;
  --bs-heading-color: inherit;
  --bs-link-color: #7a7a7a;
  --bs-link-hover-color: #959595;
  --bs-link-color-rgb: 122, 122, 122;
  --bs-link-hover-color-rgb: 149, 149, 149;
  --bs-code-color: #e685b5;
  --bs-highlight-color: #dee2e6;
  --bs-highlight-bg: #644f1a;
  --bs-border-color: #495057;
  --bs-border-color-translucent: rgba(255, 255, 255, 0.15);
  --bs-form-valid-color: #b5eb80;
  --bs-form-valid-border-color: #b5eb80;
  --bs-form-invalid-color: #fd8c8c;
  --bs-form-invalid-border-color: #fd8c8c;
}
...
.table-success {
  --bs-table-color: #000;
  --bs-table-bg: #e6f8d5;
  --bs-table-border-color: #b8c6aa;
  --bs-table-striped-bg: #dbecca;
  --bs-table-striped-color: #000;
  --bs-table-active-bg: #cfdfc0;
  --bs-table-active-color: #000;
  --bs-table-hover-bg: #d5e5c5;
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.table-warning {
  --bs-table-color: #000;
  --bs-table-bg: #fef4d9;
  --bs-table-border-color: #cbc3ae;
  --bs-table-striped-bg: #f1e8ce;
  --bs-table-striped-color: #000;
  --bs-table-active-bg: #e5dcc3;
  --bs-table-active-color: #000;
  --bs-table-hover-bg: #ebe2c9;
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.table-danger {
  --bs-table-color: #000;
  --bs-table-bg: #fed9d9;
  --bs-table-border-color: #cbaeae;
  --bs-table-striped-bg: #f1cece;
  --bs-table-striped-color: #000;
  --bs-table-active-bg: #e5c3c3;
  --bs-table-active-color: #000;
  --bs-table-hover-bg: #ebc9c9;
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.form-switch .form-check-input:focus {
  --bs-form-switch-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23919191'/%3e%3c/svg%3e");
}
...
.form-range::-webkit-slider-runnable-track {
  ...
  color: transparent;
  cursor: pointer;
  background-color: rgba(17, 19, 21, 0.6705882353);
...
.was-validated .form-control:valid, .form-control.is-valid {
  ...
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2384DE2C' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
  background-repeat: no-repeat;
...
.was-validated .form-select:valid:not([multiple]):not([size]), .was-validated .form-select:valid:not([multiple])[size="1"], .form-select.is-valid:not([multiple]):not([size]), .form-select.is-valid:not([multiple])[size="1"] {
  --bs-form-select-bg-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2384DE2C' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
...
.was-validated .form-control:invalid, .form-control.is-invalid {
  ...
  padding-right: calc(1.5em + 0.75rem);
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23FB4040'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23FB4040' stroke='none'/%3e%3c/svg%3e");
  background-repeat: no-repeat;
  background-position: right calc(0.375em + 0.1875rem) center;
  background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);
}
...
.was-validated .form-select:invalid:not([multiple]):not([size]), .was-validated .form-select:invalid:not([multiple])[size="1"], .form-select.is-invalid:not([multiple]):not([size]), .form-select.is-invalid:not([multiple])[size="1"] {
  --bs-form-select-bg-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23FB4040'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23FB4040' stroke='none'/%3e%3c/svg%3e");
  padding-right: 4.125rem;
  background-position: right 0.75rem center, center right 2.25rem;
  background-size: 16px 12px, calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);
}
...
.btn-success {
  --bs-btn-color: #000;
  --bs-btn-bg: #84DE2C;
  --bs-btn-border-color: #84DE2C;
  --bs-btn-hover-color: #000;
  --bs-btn-hover-bg: #96e34c;
  --bs-btn-hover-border-color: #90e141;
  --bs-btn-focus-shadow-rgb: 112, 189, 37;
  --bs-btn-active-color: #000;
  --bs-btn-active-bg: #9de556;
  --bs-btn-active-border-color: #90e141;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #000;
  --bs-btn-disabled-bg: #84DE2C;
  --bs-btn-disabled-border-color: #84DE2C;
}
...
.btn-warning {
  --bs-btn-color: #000;
  --bs-btn-bg: #FBC640;
  --bs-btn-border-color: #FBC640;
  --bs-btn-hover-color: #000;
  --bs-btn-hover-bg: #fccf5d;
  --bs-btn-hover-border-color: #fbcc53;
  --bs-btn-focus-shadow-rgb: 213, 168, 54;
  --bs-btn-active-color: #000;
  --bs-btn-active-bg: #fcd166;
  --bs-btn-active-border-color: #fbcc53;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #000;
  --bs-btn-disabled-bg: #FBC640;
  --bs-btn-disabled-border-color: #FBC640;
}

.btn-danger {
  --bs-btn-color: #000;
  --bs-btn-bg: #FB4040;
  --bs-btn-border-color: #FB4040;
  --bs-btn-hover-color: #000;
  --bs-btn-hover-bg: #fc5d5d;
  --bs-btn-hover-border-color: #fb5353;
  --bs-btn-focus-shadow-rgb: 213, 54, 54;
  --bs-btn-active-color: #000;
  --bs-btn-active-bg: #fc6666;
  --bs-btn-active-border-color: #fb5353;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #000;
  --bs-btn-disabled-bg: #FB4040;
  --bs-btn-disabled-border-color: #FB4040;
}
...
.btn-outline-success {
  ...
  --bs-btn-border-color: #84DE2C;
  --bs-btn-hover-color: #000;
  --bs-btn-hover-bg: #84DE2C;
  --bs-btn-hover-border-color: #84DE2C;
  --bs-btn-focus-shadow-rgb: 132, 222, 44;
  --bs-btn-active-color: #000;
  --bs-btn-active-bg: #84DE2C;
  --bs-btn-active-border-color: #84DE2C;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #84DE2C;
  --bs-btn-disabled-bg: transparent;
  --bs-btn-disabled-border-color: #84DE2C;
  --bs-gradient: none;
}
...
.btn-outline-warning {
  ...
  --bs-btn-border-color: #FBC640;
  --bs-btn-hover-color: #000;
  --bs-btn-hover-bg: #FBC640;
  --bs-btn-hover-border-color: #FBC640;
  --bs-btn-focus-shadow-rgb: 251, 198, 64;
  --bs-btn-active-color: #000;
  --bs-btn-active-bg: #FBC640;
  --bs-btn-active-border-color: #FBC640;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #FBC640;
  --bs-btn-disabled-bg: transparent;
  --bs-btn-disabled-border-color: #FBC640;
  --bs-gradient: none;
}
...
.btn-outline-danger {
  ...
  --bs-btn-border-color: #FB4040;
  --bs-btn-hover-color: #000;
  --bs-btn-hover-bg: #FB4040;
  --bs-btn-hover-border-color: #FB4040;
  --bs-btn-focus-shadow-rgb: 251, 64, 64;
  --bs-btn-active-color: #000;
  --bs-btn-active-bg: #FB4040;
  --bs-btn-active-border-color: #FB4040;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #FB4040;
  --bs-btn-disabled-bg: transparent;
  --bs-btn-disabled-border-color: #FB4040;
  --bs-gradient: none;
}
...
.dropdown-menu {
  ...
  --bs-dropdown-link-active-bg: #222;
...
.nav-pills {
  ...
  --bs-nav-pills-link-active-bg: #222;
}
.nav-pills .nav-link {
...
.accordion {
  ...
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%230e0e0e' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='M2 5L8 11L14 5'/%3e%3c/svg%3e");
...
[data-bs-theme=dark] .accordion-button::after {
  --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%237a7a7a'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%237a7a7a'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
}
...
.list-group {
  ...
  --bs-list-group-active-bg: #222;
  --bs-list-group-active-border-color: #222;
  display: flex;
  flex-direction: column;
  padding-left: 0;
  margin-bottom: 0;
...
.link-success:hover, .link-success:focus {
  color: RGBA(157, 229, 86, var(--bs-link-opacity, 1)) !important;
  text-decoration-color: RGBA(157, 229, 86, var(--bs-link-underline-opacity, 1)) !important;
}
...
.link-warning:hover, .link-warning:focus {
  color: RGBA(252, 209, 102, var(--bs-link-opacity, 1)) !important;
  text-decoration-color: RGBA(252, 209, 102, var(--bs-link-underline-opacity, 1)) !important;
}
...
.link-danger:hover, .link-danger:focus {
  color: RGBA(252, 102, 102, var(--bs-link-opacity, 1)) !important;
  text-decoration-color: RGBA(252, 102, 102, var(--bs-link-underline-opacity, 1)) !important;
}
